...
<form:form action="checkLogin" modelAttribute="userSession" method="POST">
	...
	<div class="col-lg-2 mx-auto">
	    ...
	    <button class="w-50btn btn-lg btn-dark"><a class="text-decoration-none text-white" href="<%=request.getContextPath()%>/usuarios/formularioAgregarCliente">Nuevo Cliente</a></button>
    </div>
