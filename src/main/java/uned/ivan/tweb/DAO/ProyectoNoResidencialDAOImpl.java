...
@Component
@Qualifier("noResidencial")
public class ProyectoNoResidencialDAOImpl implements ProyectoDAO {
	@Autowired
	...
	public void saveOrUpdateProject(Proyecto proyecto) throws ConstraintViolationException {
		...
		System.out.println("añadiendo proyecto no residencial");
	...
	public List<Proyecto> getProjects() {
		...
		Query<Proyecto> miQuery = miSession.createQuery("from ProyectoNoResidencial", Proyecto.class);
